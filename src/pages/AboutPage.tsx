    ...
    <section className="px-4 py-16 sm:px-6 lg:px-10">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] border border-amber-100 bg-white shadow-lg lg:grid-cols-[0.7fr_1.3fr]">
        <div className="flex flex-col justify-center p-8 sm:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600">123, Anna Salai, Chennai, Tamil Nadu 600002</p>
          <p className="mt-2 text-sm text-slate-600">Monday–Saturday: 10:00 AM–8:00 PM<br/>Sunday: 10:30 AM–6:30 PM</p>
          <a href="https://www.google.com/maps/search/?api=1&query=Anna+Salai+Chennai+Tamil+Nadu" target="_blank" rel="noreferrer" className="mt-7 inline-flex w-fit rounded-full border border-amber-500 px-6 py-3 text-sm font-semibold text-slate-800 transition hover:bg-amber-600 hover:text-white">Get directions</a>
        </div>
        <div className="min-h-[420px] bg-[#f5efe2]">
          <iframe title="Annai Jewellery showroom location" src="https://www.google.com/maps?q=Anna%20Salai%2C%20Chennai%2C%20Tamil%20Nadu&output=embed" className="h-full min-h-[420px] w-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen />
        </div>
      </div>
    </section>
  </>
