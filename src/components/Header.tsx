  ...
  return <>
    ...
    >
      ...
      <div className="relative flex h-[96px] items-center justify-between px-4 lg:hidden">
        ...
        <Link to="/" className="absolute left-1/2 flex h-[92px] w-[96px] -translate-x-1/2 items-center justify-center" aria-label="Annai Jewellery home"><span className="grid h-[60px] place-items-center"><img src={logo} alt="Annai Jewellery" className="h-[56px] w-auto max-w-none object-contain"/></span></Link>
