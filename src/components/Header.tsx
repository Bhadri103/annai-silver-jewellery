  ...
  return <>
    ...
    >
      <div className="mx-auto hidden h-[96px] max-w-7xl items-center gap-5 px-6 lg:flex lg:px-10">
        <Link to="/" className="flex h-[92px] w-[104px] shrink-0 items-center justify-center" aria-label="Annai Jewellery home"><span className="grid h-[86px] w-[86px] place-items-center"><img src={logo} alt="Annai Jewellery" className="h-[78px] w-[78px] object-contain"/></span></Link>
      ...
      <div className="relative flex h-[96px] items-center justify-between px-4 lg:hidden">
        ...
        <Link to="/" className="absolute left-1/2 flex h-[92px] w-[96px] -translate-x-1/2 items-center justify-center" aria-label="Annai Jewellery home"><span className="grid h-[86px] w-[86px] place-items-center"><img src={logo} alt="Annai Jewellery" className="h-[78px] w-[78px] object-contain"/></span></Link>
